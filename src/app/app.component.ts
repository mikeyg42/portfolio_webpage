...
@Component({
  ...
  imports: [CommonModule,RouterModule, NgOptimizedImage, BoldNamePipe, ModalComponent] 
})

export class AppComponent implements OnInit, OnDestroy, AfterViewInit {
  @ViewChildren('card') cards!: QueryList<ElementRef>;

  title = 'Michael Glendinning';
  ...
  articles: Publication[] = [
    ...
    },
    {
      ...
      journalLink: 'https://doi.org/10.1093/brain/awab148',
      directDownload: 'https://storage.googleapis.com/resume_page/content/covid19_paper_BRAIN.pdf',
      imageSrc: 'https://storage.googleapis.com/resume_page/content/brain_figure.jpeg',
      width1: 520,
      height1: 571 ,
      videoSrc:'',
      imageSrc2: '',
